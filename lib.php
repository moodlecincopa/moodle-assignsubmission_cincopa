<?PHP
// This file is part of the cincopa submission sub plugin - http://elearningstudio.co.uk
//
...
/**
 * This file contains the moodle hooks for the submission cincopa plugin
 *
...
function assignsubmission_cincopa_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    ...
    $fullpath = "/{$context->id}/assignsubmission_cincopa/$filearea/$itemid/$relativepath";
